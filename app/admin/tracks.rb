ActiveAdmin.register Track do
  ...
  filter :collections, as: :select, collection: -> { Collection.pluck(:id) }
  ...
  form do |f|
    ...
    f.inputs do
      ...
      f.input :collections, as: :searchable_select, collection: Collection.pluck(:id), multiple: true, input_html: {

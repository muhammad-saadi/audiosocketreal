class Api::V1::Collaborator::TracksController < Api::V1::Collaborator::BaseController
  ...
  def index
    ...
    render json: @tracks.includes(%i[publisher wav_file_attachment aiff_file_attachment mp3_file_attachment], artists_collaborator: :collaborator),
  ...
  def track_params
    params.permit(:title, :wav_file, :aiff_file, :mp3_file, :public_domain, :status, :lyrics, :explicit, :parent_track_id, track_publishers: %i[publisher_id percentage],

...
PER_PAGE = 10
EMAIL_TEMPLATES = {
  approved: "<p>Hello [name]!</p><p>Thanks for submitting music to Audiosocket, we listened to your link and would love to work with you!</p>
  ...
  <p>You can check out some of our recent placements here,it's a great time to come onboard.Please let us know if you have any questions.</p>Thanks!<br>Vanessa",
